...
</span></code></pre><ng-doc-demo componentname="BarChartDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">\{\}</div></ng-doc-demo><h2 id="chart-types" class="ngde">Chart Types<a title="Link to heading" class="ng-doc-header-link ngde" href="/chart-components/bar-chart#chart-types"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">The component supports different chart types:</p><ul class="ngde"><li class="ngde"><code class="ngde">bar</code>: Standard vertical bar chart</li><li class="ngde"><code class="ngde">horizontalBar</code>: Horizontal bar chart</li><li class="ngde"><code class="ngde">stackedBar</code>: Stacked bar chart</li><li class="ngde"><code class="ngde">stackedHorizontalBar</code>: Stacked horizontal bar chart</li></ul><pre class="ngde hljs"><code class="hljs language-typescript code-lines ngde" lang="typescript" name="" icon="" highlightedlines="[]"><span class="line ngde">&#x3C;app-bar-chart
...
</span></code></pre><ng-doc-demo componentname="BarChartDemoComponent" indexable="false" class="ngde"><div id="options" class="ngde">\{\}</div></ng-doc-demo><h2 id="styling" class="ngde">Styling<a title="Link to heading" class="ng-doc-header-link ngde" href="/chart-components/bar-chart#styling"><ng-doc-icon icon="link-2" size="16" class="ngde"></ng-doc-icon></a></h2><p class="ngde">You can customize the appearance using various properties:</p><pre class="ngde hljs"><code class="hljs language-typescript code-lines ngde" lang="typescript" name="" icon="" highlightedlines="[]"><span class="line ngde">&#x3C;app-bar-chart
</span><span class="line ngde">  [data]=<span class="hljs-string ngde">"data"</span>
</span><span class="line ngde">  x=<span class="hljs-string ngde">"month"</span>
</span><span class="line ngde">  y=<span class="hljs-string ngde">"sales"</span>
